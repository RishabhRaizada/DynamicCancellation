...
#     raise RuntimeError("No MCP JSON response")
...
# 4. STUDENT and HIGHSPENDER logic has HIGHEST PRIORITY and OVERRIDES all other rules.
...
# ======================================
# MCP EXECUTOR (IDENTICAL TO testing.py)
# ======================================
