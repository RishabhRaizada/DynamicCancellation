...
# def extract_available_seats_from_seatmap(seatmap_json: dict):
#     """
#     Traverses Navitaire-style seatMap structure
#     and returns ALL assignable & available seats
#     in a flat list for agent reasoning.
#     """
...
#                             "travelClassCode": seat.get("travelClassCode"),
#                             "availability": seat.get("availability"),
#                             "properties": seat.get("properties", [])
#                         })
